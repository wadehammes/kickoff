...
is_template_css_file() {
  case "$1" in
    */src/templates/styles.ts | src/templates/styles.ts) return 0 ;;
    */src/templates/components.ts | src/templates/components.ts) return 0 ;;
    */src/templates/app.ts | src/templates/app.ts) return 0 ;;
    *) return 1 ;;
  esac
}
